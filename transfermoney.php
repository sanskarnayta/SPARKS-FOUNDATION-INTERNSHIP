...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center">The People's Bank</a>
...
?> 
                    ...
                    <h3>Transfer Details</h3>
                        ...
                        <img src="images/10l.png" style="width:130px;height:60px;">
                    </div>
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:60px;height:380px;">
                   <div class="card-body">
                   <img src="images/66.png" style="width:250px;height:220px;margin-top:40px;">
          ...
          <div class="col-sm-4">
                <div class="card text-center" style="margin-top:76px;background-color:#7A3DAF;border-radius:10px;color:white">
                   ...
                   <h3>Transfer Details</h3>
                    ...
                    <img src="images/10r.png" style="width:130px;height:60px;">
                   </div>
