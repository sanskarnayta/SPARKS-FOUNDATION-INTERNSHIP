...
.main_div
{
    width:100%;
    height:100vh;
    background-image:linear-gradient(to left, #FEECE9,#944BD3,#7A3DAF,#692C9F,#562284,#4B1C74);
...
.contactus:before{
    ...
    bottom: 0;
    right:0;
    background:linear-gradient(20deg,#5E11A3 55%, #9C19E0 0%);
    z-index: -1;
}
.formbutton button{
...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center"><h2>The People's Bank</h2></a>
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <img src="images/121212.png" class="img-fluid" width="591" height="422" style="margin-top:20px;">
           
          </div>
          <div class="col-sm-6">
            <h1 class="main_text">The People's Bank</h1>
            <p class="big-text">Small steps towards a better future</p>
          </div>
  ...
  <section class="contactus" id="contact" >
        <div class="container headings text-center">
            ...
            <p>We're always there for you.You can contact us anytime 24*7</p>
